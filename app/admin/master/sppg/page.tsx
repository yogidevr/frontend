...
export default function Page() {
    ...
    const { data: mitraData } = useFetch<any>("/mitra?per_page=100");
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await api.get<ApiListResponse<Product>>("/sppg", {
                params: {
                ...
                <table className="w-full text-sm">
                    <thead className="bg-white shadow-lg">
                        <tr>
                            ...
                            <th className="p-3">
                                <button onClick={() => handleSort("nama_sppg")} className={`flex items-center gap-2 transition-colors ${getSortClass(
                                    sortField,
                                    "nama_sppg"
                                )}`}>
                            ...
                            <th className="p-3">
                                <button onClick={() => handleSort("nama_penanggungjawab")} className={`flex items-center gap-2 transition-colors ${getSortClass(
                                    sortField,
                                    "nama_penanggungjawab"
                                )}`}>
                            ...
                            <th className="p-3">
                                <button onClick={() => handleSort("no_penanggungjawab")} className={`flex items-center gap-2 transition-colors ${getSortClass(
                                    sortField,
                                    "no_penanggungjawab"
                                )}`}>
