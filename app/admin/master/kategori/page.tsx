...
export default function Page() {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await api.get<ApiListResponse<Product>>("/kategori", {
                params: {
                ...
                <table className="w-full text-sm">
                    <thead className="bg-white shadow-lg">
                        <tr>
                            ...
                            <th className="p-3">
                                <button onClick={() => handleSort("kode")} className={`flex items-center gap-2 transition-colors ${getSortClass(
                                    sortField,
                                    "kode"
                                )}`}>
                            ...
                            <th className="p-3">
                                <button onClick={() => handleSort("nama_satuan")} className={`flex items-center gap-2 transition-colors ${getSortClass(
                                    sortField,
                                    "nama_satuan"
                                )}`}>
